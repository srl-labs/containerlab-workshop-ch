...
```bash
cd ~
git clone https://github.com/alinc01/clab_workshop_ch.git
cd clab_workshop_ch/10-basics
```

The repo should be cloned and you should be in the `clab_workshop_ch` directory as per the output below:

```
[*]─[vm4]─[~/clab_workshop_ch/10-basics]
└──>
```
...
```bash
[*]─[vm4]─[~/clab_workshop_ch/10-basics]
└──> containerlab inspect -t ~/clab_workshop_ch/10-basics/
