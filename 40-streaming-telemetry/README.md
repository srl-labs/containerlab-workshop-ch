...
└──> ls
LICENSE  README.md  clab-st  configs  <span style="color:red; font-weight:bold">st.clab.drawio</span>  st.clab.yml  st.clab.yml.annotations.json  streaming-telemetry.drawio  traffic.sh
```
